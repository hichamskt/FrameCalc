...
const Notifications = ({ setNotifCount }: NotificationProps) => {
  ...
  const { notif, Loading, setLoading, next, setRefresh } = UseNotification();
  ...
  return (
    <div className="absolute top-12 right-0 bg-white w-96 rounded-xl shadow-xl border border-gray-200 z-50">
      {/* Header */}
