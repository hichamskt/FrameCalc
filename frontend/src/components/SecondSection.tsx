    ...
    return(
        ...
        data-aos-duration="1000"
         className="max-w-[60%] xl:text-5xl lg:text-4xl md:text-3xl sm:text-2xl font-normal mb-20">
                <p> From sketch to structure, we combine shape detection, OCR, and real-time estimation to help you build faster & waste less.</p>
            </div>
            <div
             className="sm:grid sm:grid-cols-2 sm:grid-rows-3 flex flex-col sm:gap-10 gap-3 text-[20px] ">
        ...
        data-aos-duration="1000"
            className="col-start-2 row-start-3 text-[16px] font-thin leading-relaxed pb-4 ">
                <p>Smart aluminum insights from hand-drawn plans — designed with builders in mind.
Sketch, scan, and build. Smarter, faster, and without the hassle.
Built for makers. Loved by doers. Powered by precision.</p>
            </div>
            </div>
        </div>
    )
