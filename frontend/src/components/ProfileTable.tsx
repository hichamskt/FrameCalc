...
handleUpdate(editForm as ProfileAlum, editingId);
  ...
  const handleInputChange = (field: keyof ProfileAlum, value: string | number): void => {
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400 text-lg">Manage your profiles with ease</p>
        </div>
        ...
        <div className="bg-gray-900/40 backdrop-blur-xl rounded-2xl shadow-2xl border border-gray-700/30 overflow-hidden ">
            ...
            <table className="w-full">
              <thead>
                <tr className="bg-gradient-to-r from-gray-800/80 to-gray-700/80 backdrop-blur-sm border-b border-gray-600/50">
                  <th className="px-6 py-5 text-left text-sm font-semibold text-gray-200 uppercase tracking-wider">ID</th>
                  <th className="px-6 py-5 text-left text-sm font-semibold text-gray-200 uppercase tracking-wider">Company</th>
                  <th className="px-6 py-5 text-left text-sm font-semibold text-gray-200 uppercase tracking-wider">Company Name</th>
                  <th className="px-6 py-5 text-left text-sm font-semibold text-gray-200 uppercase tracking-wider">Name</th>
                  <th className="px-6 py-5 text-left text-sm font-semibold text-gray-200 uppercase tracking-wider">Quality</th>
          ...
          {filteredProfiles.length === 0 && (
            <div className="text-center py-16">
              ...
              <p className="text-gray-400 text-xl font-medium mb-2">No profiles found</p>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-gray-900/40 backdrop-blur-xl rounded-xl p-6 border border-gray-700/30">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-400 text-sm font-medium">High Quality</p>
                <p className="text-2xl font-bold text-white">
                  {profiles.filter(p => p.quality.toLowerCase().includes('high')).length}
                </p>
              </div>
